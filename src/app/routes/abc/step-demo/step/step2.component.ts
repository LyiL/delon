...
@Component({
    selector:'step-2',
    template:`<form nz-form [formGroup]="form" (ngSubmit)="_submitForm()">
        ...
        <div nz-form-item nz-row>
            <div nz-form-control nz-col [nzSpan]="20" [nzOffset]="4">
                ...
                <button nz-button type="button" (click)="prev()" nzSize="large">上一步</button>
            </div>
        </div>
    </form>`
})
export class Step2Component{
    ...
    constructor(private fb: FormBuilder, public item: TransferService,private dynamicStepsService:DynamicStepsService) {}
